package com.microservices_example_app.users.audit;
...
public class AuditLoggingAspect {
    ...
    @Pointcut("execution(* com.microservices_example_app.users.service.*.register(..)) || " +
              "execution(* com.microservices_example_app.users.service.*.delete*(..)) || " +
              "execution(* com.microservices_example_app.users.service.*.update*(..)) || " +
              "execution(* com.microservices_example_app.users.service.*.resetPassword(..)) || " +
              "execution(* com.microservices_example_app.users.service.*.restorePassword(..))")
